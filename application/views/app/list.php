...
<head>
    ...
    <!-- Title  -->
    <title>Aditya Property - Real EAll State Agency | List  </title>
...
<link rel="stylesheet" href="<?=base_url('assets/css/')?>my.css">
  ...
  <!--   <div id="preloader">
    ...
    <header class="header-area fixed-top">
        ...
        <!-- Top Header Area -->
        <div class="top-header-area display-md">
                        ...
                        <div class="classynav text-center" style="align-items: center!important;">
                            <ul class="text-left">  
                                ...
                                <li><a href="#">Property Type</a>
                                    <div class="megamenu d-lg-flex text-left" style="background-color: #fff;width: fit-content">
                                        <ul class="single-mega ">
                                            <li class="title"><h4>RESIDENTIAL</h4></li>
                                            <li> 
                                        ...
                                        <ul class="single-mega ">
                                            <li class="title"><h4>ALL AGRICULTURAL</h4></li>
                                            <li> 
                                ...
                                <li><a href="#">BHK</a>
                                    <div class="megamenu d-lg-flex" style="background-color: #fff;width: fit-content">
                                        <ul class="single-mega ">
                                            <li class="title"><h4>Select  BHK</h4></li>
                                            <li> 
                                                <div class="form-check">
                                                    <label>
                                                        <input type="checkbox" class="bhk" value="1" name="bhk[]"> <span class="label-text">BHK 1</span>
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label>
                                                        <input type="checkbox" class="bhk" value="2" name="bhk[]"> <span class="label-text">BHK 2</span>
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label>
                                                        <input type="checkbox" class="bhk" value="3" name="bhk[]"> <span class="label-text">BHK 3</span>
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label>
                                                        <input type="checkbox" class="bhk" value="4" name="bhk[]"> <span class="label-text">BHK 4</span>
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label>
                                                        <input type="checkbox" class="bhk" value="5" name="bhk[]"> <span class="label-text">BHK 5</span>
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label>
                                                        <input type="checkbox" class="bhk" value="6" name="bhk[]"> <span class="label-text">> BHK 6</span>
                                                    </label>
                                                </div>
                                            </li>
                                        </ul>
                                   ...
                                   <div class="megamenu d-lg-flex" style="background-color: #fff;width: fit-content;display: inline;left: -800px">
                                        <ul class="single-mega text-black  ">
                                            <li class="title text-center d-lg-flex" style="z-index: 1">Area <a href="#"><span class="glyphicon glyphicon-chevron-down"></span></a>                                                
                                             ...
                                             <li class="title text-center d-lg-flex" style="z-index: 1">Bathroom <a href="#"><span class="glyphicon glyphicon-chevron-down"></span></a></li> 
                                              <li style="display: flex;"> 
                                                    <div class="form-check " style="width: 100%">
                                                      
                                                        <select name="bathroom" class="form-control bathroom" id="">
