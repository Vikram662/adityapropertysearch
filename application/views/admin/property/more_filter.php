            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" action="<?=base_url('admincp/property/update_filter/'.@$this->uri->segment(4))?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                              <div class="checkbox col-sm-3">
                               ...
                               <div class="checkbox col-sm-3">
                                <label>
                                  <input type="radio"  name="facing" value="West" class="flat" > West
                                </label>
                              </div>
                                <div class="checkbox col-sm-3">
                                <label>
