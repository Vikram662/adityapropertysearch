                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12" style="border:0px solid #e5e5e5;">
                      ...
                      <div class="">
                        <a href="<?= base_url('admincp/property/edit/'.$property->id)?>" class="btn btn-default btn-lg">Edit</a>
                       ...
                       <div class="col-md-55">
                        <div class="">
                          <div class="image view view-first">
                            <span class="notify-badge"><a onclick="return confirm('Are you sure you want to delete this item?');" href="<?=base_url('admincp/property/gallery_del/')?><?php echo $image['g_id']?>"><i class="fa fa-times"></i></a></span>
