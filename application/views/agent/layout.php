<?php
  ...
  if($user->no_verify==0){
    if($this->uri->segment(2)!='dashboard'){
      $this->session->set_flashdata('vr', 'Please verify Mobile No.');
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?=base_url($user->img)?>" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('agent')?>"><i class="fa fa-home"></i> Dashboard </a>
                  <li><a href="<?=base_url('agent/property')?>"><i class="fa fa-building"></i> Property </a>
                    <li><a href="<?=base_url('agent/project')?>"><i class="fa fa-building"></i> Projects </a>
                  
                  </li>
                  <?php if($this->session->userdata('access')=="Admin"){
                    ?>
                     <li><a href="<?=base_url('agent/dashboard/admin')?>"><i class="fa fa-building"></i> Back To Admin </a>
                    <?php
                  } ?>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?=base_url($user->img)?>" alt=""><?=$user->name?>
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="<?=base_url('agent/profile')?>"> Profile</a></li>
                    <!-- <li>
                      <a href="<?=base_url('agent/setting')?>">
                        <span>Settings</span>
                      </a>
                    </li> -->
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="<?=base_url($user->img)?>" alt="Profile Image" /></span>
                        <span>
