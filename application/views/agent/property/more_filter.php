                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" action="<?=base_url('agent/property/update_filter/'.@$this->uri->segment(4))?>" method="post" enctype="multipart/form-data">
                         <?php if($property->sale_type!="Rent") {?>
                    ...
                    <?php }else{
                      ?>
                       <div class="form-group">
                        <label class="col-md-3 col-sm-3 col-xs-12 control-label">Tenants Preferred
                        </label>

                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <div class="radio col-sm-3 ">
                            <label>
                              <input type="radio" value="ALL" <?=$property->tenants_condtion=='ALL'?'checked':''?> class="flat" name="tenants_condtion"> ALL
                            </label>
                          </div>
                          
                          <div class="radio col-sm-3">
                            <label>
                              <input type="radio" value="Family" <?=$property->tenants_condtion=='Family'?'checked':''?> class="flat"  name="tenants_condtion"> Family
                            </label>
                          </div>
                          <div class="radio col-sm-3 ">
                            <label>
                              <input type="radio" value="Boys" <?=$property->tenants_condtion=='Boys'?'checked':''?> class="flat" name="tenants_condtion"> Boys
                            </label>
                          </div>
                          <div class="radio col-sm-3 ">
                            <label>
                              <input type="radio" value="Girls" <?=$property->tenants_condtion=='Girls'?'checked':''?> class="flat" name="tenants_condtion"> Girls
                            </label>
                          </div>
                      ...
                      <?php
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <div class="radio col-sm-3">
                            <label>
                              <input type="radio" value="Furnished" <?=$property->furnish=='Furnished'?'checked':''?> class="flat"  name="furnish"> Furnished
                            </label>
                          </div>
                          <div class="radio col-sm-3 ">
                            <label>
