            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="about-content">
                        <img class="wow fadeInUp" data-wow-delay="350ms" src="<?=base_url('assets/')?>img/bg-img/about.jpg" alt="">
                    ...
                    <div class="featured-properties-slides owl-carousel wow fadeInUp" data-wow-delay="350ms">
                        ...
                        <div class="single-featured-property">
                            ...
                            <div class="property-thumb">
                                <img src="<?=base_url('assets/')?>img/bg-img/feature1.jpg" alt="">
                            ...
                            <div class="property-content">
                                ...
                                <p class="location"><img src="<?=base_url('assets/')?>img/icons/location.png" alt="">Upper Road 3411, no.34 CA</p>
                        ...
                        <div class="single-featured-property">
                            <!-- Property Thumbnail -->
                            <div class="property-thumb">
                                <img src="<?=base_url('assets/')?>img/bg-img/feature2.jpg" alt="">
                        ...
                        <div class="single-featured-property">
                            <!-- Property Thumbnail -->
                            <div class="property-thumb">
                                <img src="<?=base_url('assets/')?>img/bg-img/feature3.jpg" alt="">
                        ...
                        <div class="single-featured-property">
                            <!-- Property Thumbnail -->
                            <div class="property-thumb">
                                <img src="<?=base_url('assets/')?>img/bg-img/feature4.jpg" alt="">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-team-member mb-100 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="team-member-thumb">
                            <img src="<?=base_url('assets/')?>img/bg-img/team1.jpg" alt="">
                        </div>
                        <!-- Team Member Info -->
                        <div class="team-member-info">
                            <div class="section-heading">
                                <img src="<?=base_url('assets/')?>img/icons/prize.png" alt="">
                                <h2>Jeremy Scott</h2>
                                <p>Realtor</p>
                            </div>
                            <div class="address">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-team-member mb-100 wow fadeInUp" data-wow-delay="500ms">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="<?=base_url('assets/')?>img/bg-img/team2.jpg" alt="">
                        </div>
                        <!-- Team Member Info -->
                        <div class="team-member-info">
                            <div class="section-heading">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-team-member mb-100 wow fadeInUp" data-wow-delay="750ms">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="<?=base_url('assets/')?>img/bg-img/team3.jpg" alt="">
                        </div>
                        <!-- Team Member Info -->
                        <div class="team-member-info">
                            <div class="section-heading">
